...
public final class Distribution
{
     ...
     */
    public static final double[][] ChiSquareTable = {
     ...
     */
    public static final double[] PvalueTable = {0.95, 0.90, 0.80, 0.70, 0.50, 0.30, 0.20,
                                                0.10, 0.05, 0.01, 0.001};

    /**
     * Computes chi-square value and p-value for the given 2x2 contingency table. It also
     * answers a reliability indicator: {@code true} if all expected values are &gt;= 5.0;
     * {@code false} if at least one of the expected values is &lt; 5.0.
     *
     * @param c11
